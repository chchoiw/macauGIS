...
(function (window, document, undefined) {
    ...
    L.WindBarb.Icon = L.Icon.extend({
        ...
        createIcon: function () {
            ...
            // div.node().style.width = '500px';
            // div.node().style.zIndex = '900';
            div.setAttribute('style',"900px");
            // console.log("div",div)
        ...
        _createPoint: function() {
            var svg, w,h, sw, r, fc,pathColor, circleBorderColor;
            sw = this.options.strokeWidth, r = this.options.pointRadius, fc = this.options.fillColor;
            pathColor=this.options.pathColor;
            circleBorderColor=this.options.circleBorderColor;
            ...
            var c = document.createElementNS (xmlns, 'circle');
                c.setAttributeNS (null, 'stroke', circleBorderColor);
        ...
        _createBarbs: function(speed) {
            var s, b, bn, bw, bh, bs, sw, sl, p, r, w, h, cx, cy, vb, xmlns, svg, g, fd,pathColor;
            s = speed,
            b = {5:0,10:0,50:0}
            ...
            if(fd === true){
                ...
                var path = document.createElementNS (xmlns, "path");
                    path.setAttributeNS (null, 'stroke', pathColor);
                ...
                if(b[50]>0){
                    ...
                    for(var i=0;i<b[50];i++){
                        ...
                        var path = document.createElementNS (xmlns, "polygon");
                            path.setAttributeNS (null, 'stroke', pathColor);
                            path.setAttributeNS (null, 'stroke-width', sw);
                            path.setAttributeNS (null, 'fill', pathColor);                                
        ...
        createShadow: function () {
            ...
            var div = document.createElement('div'); 
            div.setAttribute("class", "windBarbDivClass");
            ...
            b.svg.setAttribute("class","windBarbClass");
